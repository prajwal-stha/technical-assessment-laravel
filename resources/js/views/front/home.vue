                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="6">
                                <ValidationProvider
                                    ...
                                    v-slot="{ errors }"
                                    class="validation-wrapper">
                                    <v-text-field v-model="customerDetails.email" name="email" type="email"
                                                  label="Email *">
                                    </v-text-field>
                                    <span v-if="errors.length" class="error-message">{{ errors[0] }}</span>
                                </ValidationProvider>
                        ...
                        <v-row>
                            <v-col cols="12" md="6">
                                <div class="md-date-picker"
                                     :class="{'isDobInserted':customerDetails.date_of_birth != null}">
                            ...
                            <div class="card p-2">
                                ...
                                <div class="card-body">
                                    <div v-for="(education, index) in customerDetails.education_details" :key="index">
                                        <div class="card ">
                                            ...
                                            <v-row>
                                                <v-col cols="12" md="4"
                                                    ...
                                                    <div class="md-date-picker"
                                                         :class="{'isDobInserted':customerDetails.education_details[index].start_date != null}">
                                                        <ValidationProvider
                                                            v-slot="{ errors }"
                                                ...
                                                <v-col cols="12" md="4"
                                                    ...
                                                    <div class="md-date-picker"
                                                         :class="{'isDobInserted':customerDetails.education_details[index].end_date != null}">
                                                        <ValidationProvider
                                                            v-slot="{ errors }"
                                        ...
                                        <div class="form-group text-center m-3" v-if="eligibleRemoveTask()">
                                            <button @click="removeEducationDetails(index)" type="button"
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (valid) {
                this.loading = true
                axios.post('/api/customer-details/store', this.customerDetails)
                    .then((response) => {
